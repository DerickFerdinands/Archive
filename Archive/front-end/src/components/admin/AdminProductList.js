import {styles} from "../home/categories/categoryTile/styles";
import {ArrowRightIcon} from "@heroicons/react/24/outline";
import {useNavigate} from 'react-router-dom';

export const AdminProductList = ({products,handleProductOnClick}) => {
                            ...
                            <div className="mt-4 flex justify-between">
                                <div>
                                    <h3 className="text-sm text-gray-700">
                                        <h5 onClick={()=>{
                                            handleProductOnClick(product.code,product.name,product.brand,product.category,product.description,product.options, product.price, product.imageUrls)
                                        }}>
