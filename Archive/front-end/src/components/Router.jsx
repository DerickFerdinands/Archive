...
return<>
        ...
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path={"/product"} element={<ProductDetails user={user} setUser={setUser} setIsHidden={setIsHidden}/>}/>
                <Route path={"/products/:category"} element={<ProductScreen user={user} setUser={setUser} setIsHidden={setIsHidden}/>}/>
